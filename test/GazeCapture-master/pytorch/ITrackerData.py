...
class ITrackerData(data.Dataset):
    def __init__(self, dataPath, split = 'train', imSize=(224,224), gridSize=(25, 25)):
        ...
        #metaFile = "D:\desktop\GazeCapture-master\pytorch\newdata\metadata.mat"
        ...
        self.faceMean = loadMetadata(os.path.join("D:\desktop\GazeCapture-master\pytorch", 'mean_face_224.mat'))['image_mean']
        self.eyeLeftMean = loadMetadata(os.path.join("D:\desktop\GazeCapture-master\pytorch", 'mean_left_224.mat'))['image_mean']
        self.eyeRightMean = loadMetadata(os.path.join("D:\desktop\GazeCapture-master\pytorch", 'mean_right_224.mat'))['image_mean']
    ...
    def __getitem__(self, index):
        ...
        with open(os.path.join(r'D:\Desktop\GazeCapture-master\pytorch\GazeCapture\%05d', 'info.json') % self.metadata['labelRecNum'][index]) as f:
                data = json.load(f)

        #info = json.loads(os.path.join('r\D:\Desktop\GazeCapture-master\pytorch\GazeCapture\%05d', 'info.json') % self.metadata['labelRecNum'][index])
        ...
        #return row, imFace, imEyeL, imEyeR, faceGrid, gaze,device
        return imFace, gaze
